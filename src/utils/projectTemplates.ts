...
export const projectTemplates: ProjectTemplate[] = [
  {
    ...
    project: {
      ...
      icon: "WD",
      accentColor: "#3b82f6",
      coverImage: "align-gradient-cobalt",
      notes: [],
    },
    milestones: [
  ...
  },
  {
    ...
    project: { name: "Client Handoff", description: "Client-safe handoff notes, completed work, and next steps.", area: "business", status: "active", priority: "medium", mood: "client", icon: "CH", accentColor: "#ef476f", coverImage: "align-gradient-rose", notes: [] },
  ...
  },
  {
    ...
    project: { name: "Personal Website Revamp", description: "Personal website strategy, design, and rebuild.", area: "personal", status: "active", priority: "medium", mood: "personal", icon: "PW", accentColor: "#3b82f6", coverImage: "align-gradient-slate", notes: [] },
